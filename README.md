...
配置教学：[此处填入你的 BV 号链接]
🚀 快速上手 (EXE 便携版)
下载路径: [蓝奏云链接] (密码: 6666) | [GitHub Releases]
环境准备: 运行前请确保安装 Visual C++ 2015-2022 运行库。
路径规范: 请务必解压至 全英文路径 运行，否则 Live2D 核心组件可能加载失败。
项目状态: 本项目目前为 Final Version (最终版)，逻辑已稳定脱敏。
🌎 English Version
...
Download: [Lanzou Link] (Passcode: 6666)
Prerequisites: Ensure Microsoft Visual C++ 2015-2022 Redistributable is installed.
Project Status: This is the Final Version. The logic has been stabilized and sensitive information has been sanitized. No further major updates are planned.
